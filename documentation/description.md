...
Поделиться просмотром:
пользователя, не являющиеся владельцами доски могут просматривать ее содержание без возможности редактирования, перейдя по ссылке, генерируемой владельцем доски.
