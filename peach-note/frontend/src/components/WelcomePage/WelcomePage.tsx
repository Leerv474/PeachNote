          ...
          <div className={style.card_container}>
            <div className={classNames(style.card, style.start_card)}>
              ...
              <div className={style.btn_container}>
                <div className={style.button_tmp}>sign up</div>
                <div className={style.button_tmp}>sign in</div>
              </div>
            </div>
            ...
            <div className={classNames(style.card, style.features)}>
              ...
              <div className={style.features_list}>
                ...
                <li>
                  <b>Organize:</b> Categorize tasks into boards, status tables,
                  or projects.
                </li>
                <li>
                ...
                <li>
                  <b>Engage:</b> Execute tasks according to their assigned
